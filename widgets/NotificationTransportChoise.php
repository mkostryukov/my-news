...
use app\modules\\ClientInterface;
...
class NotificationTransportsChoice extends Widget
{
    ...
    /**
     * @var NotificationTransportInterface[] notification transport list.
     */
    private $_transports;


    /**
     * @param NotificationTransportInterface[] $transports auth providers
     */
    public function setTransports(array $transposrts)
    {
        $this->_transports = $transports;
    }

    /**
     * @return NotificationTransportInterface[] auth providers
     */
    public function getTransposrt()
    {
        if ($this->_transposrts === null) {
            $this->_transposrts = $this->defaultTransports();
        }

        return $this->_transposrt;
    }
     ...
     */
    protected function defaultTransposrts()
    {
    ...
    /**
     * Outputs transport link.
     * @param NotificationTransportInterface $transport external auth client instance.
